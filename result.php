	...
	<nav class="navbar">
		<nav class="navs">
			...
			<nav id="nav2">
				...
				<a href="index.php" class="tagth">Exit</a>
		...
		<div class="dash1">
			...
			<?php 
				...
				while($row = $result->fetch_assoc()){
					...
					echo "<input type='submit' name='groups' class='groups' value='".$row['gname']."'><br>";
					echo "</form>";
				}
				...
				<table>
					...
					<tr>
						...
						<td><?php
							...
							$sql = "SELECT marko FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['marko'];
							}
					...
					<tr id="row1">
						...
						<td><?php
							...
							$sql = "SELECT markt FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['markt'];
							}
					...
					<tr>
						...
						<td><?php
							...
							$sql = "SELECT markth FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['markth'];
							}
					...
					<tr id="row1">
						...
						<td><?php
							...
							$sql = "SELECT markf FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['markf'];
							}
					...
					<tr>
						...
						<td><?php
							...
							$sql = "SELECT markfv FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['markfv'];
							}
					...
					<tr id="row1">
						...
						<td><?php
							...
							$sql = "SELECT marks FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['marks'];
							}
					...
					<tr>
						...
						<td><?php
							...
							$sql = "SELECT markse FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['markse'];
							}
					...
					<tr id="row1">
						...
						<td><?php
							...
							$sql = "SELECT markei FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['markei'];
							}
					...
					<tr>
						...
						<td><?php
							...
							$sql = "SELECT markn FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['markn'];
							}
					...
					<tr id="row1">
								...
								<tr>
									<td>
										<?php 
											...
											$sql = "SELECT itemo FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
									...
									<td>
										<?php 
											...
											$sql = "SELECT amounto FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
									...
									<td>
										<?php 
											...
											$sql = "SELECT costo FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
								...
								<tr style="background: white;">
									<td>
										<?php 
											...
											$sql = "SELECT itemt FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
									...
									<td>
										<?php 
											...
											$sql = "SELECT amountt FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
									...
									<td>
										<?php 
											...
											$sql = "SELECT costt FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
								...
								<tr>
									<td>
										<?php 
											...
											$sql = "SELECT itemth FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
									...
									<td>
										<?php 
											...
											$sql = "SELECT amountth FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
									...
									<td>
										<?php 
											...
											$sql = "SELECT costth FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
								...
								<tr style="background: white;">
									<td>
										<?php 
											...
											$sql = "SELECT itemf FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
									...
									<td>
										<?php 
											...
											$sql = "SELECT amountf FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
									...
									<td>
										<?php 
											...
											$sql = "SELECT costf FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
								...
								<tr>
									<td>
										<?php 
											...
											$sql = "SELECT itemfv FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
									...
									<td>
										<?php 
											...
											$sql = "SELECT amountfv FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
									...
									<td>
										<?php 
											...
											$sql = "SELECT costfv FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
								...
								<tr style="background: white;">
									<td>
										<?php 
											...
											$sql = "SELECT items FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
												echo "<input type='text' name='items' class='ins' value='".$row['items']."'>";
											}
									...
									<td>
										<?php 
											...
											$sql = "SELECT amounts FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
												echo "<input type='number' name='amounts' class='ins' value='".$row['amounts']."'>";
											}
									...
									<td>
										<?php 
											...
											$sql = "SELECT costs FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
												echo "<input type='number' name='costs' class='ins' value='".$row['costs']."'>";
											}
									...
									<td>
										<?php 
											...
											$sql = "SELECT total FROM budgets WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND groupname = '$group'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
						...
						<td><?php
							...
							$sql = "SELECT markte FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['markte'];
							}
					...
					<tr>
						...
						<td><?php
							...
							$sql = "SELECT markel FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['markel'];
							}
					...
					<tr id="row1">
						...
						<td><?php
							...
							$sql = "SELECT total FROM results WHERE form = '$class' AND subject = '$subject' AND stream = '$stream' AND gname = '$group'";
							$result = mysqli_query($conn, $sql);
							while($row = $result->fetch_assoc()){
								echo $row['total']." out of 10";
							}
