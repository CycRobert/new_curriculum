	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".tago").on("click", function(){
				alert("You cannot go to this page right now because you will be logged out, click back at the top and then log out from the dashboard page");
			})
		})
	</script>
</head>
	...
	<nav class="navbar">
		<nav class="navs">
			...
			<nav id="nav2">
				...
				<a href="download.php" class="tagt">Download</a>
