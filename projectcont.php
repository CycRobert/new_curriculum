	...
	<div class="head">
		...
		<div class="notes">
			<p class="para" id="para">
				In this section, the system will help you make changes to<br>poject data that you had inserted.
			</p>
		</div>
	</div>
	<h1 class="h11">Identify your group and project</h1>
					...
					<div class="classes">
						<?php
										// error_reporting(0);
											...
											$sql = "SELECT names FROM students WHERE form = '$class' AND stream = '$stream'";
											$result = mysqli_query($conn, $sql);
											while($row = $result->fetch_assoc()){
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		echo "<script>alert('Ensure that you have spelt everything you have entered correctly'); location.href='projecont.php';</script>";
	}
